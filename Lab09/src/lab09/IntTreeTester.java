...
public class IntTreeTester {
	public static void main(String[] args){
		...
		if (!tree_ref2.printLevel(1).equals("2\n"))
			System.err.println("TEST1 FAILED: printLevel() with tree_ref2");
		
		

		if (!tree_ref2.printLevel(2).equals("8\n1\n"))
			System.err.println("TEST2 FAILED: printLevel() with tree_ref2");

		if (!tree_ref2.printLevel(3).equals("0\n7\n6\n"))
			System.err.println("TEST3 FAILED: printLevel() with tree_ref2");

		if (!tree_ref2.printLevel(4).equals("4\n9\n"))
			System.err.println("TEST4 FAILED: printLevel() with tree_ref2");

		if (!tree_ref2.printLevel(5).equals(""))
			System.err.println("TEST5 FAILED: printLevel() with tree_ref2");
